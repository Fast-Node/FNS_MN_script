...
CONFIG_FILE='fastnode.conf'
CONFIGFOLDER='/root/.fastnode'
COIN_DAEMON='/usr/local/bin/fastnoded'
COIN_CLI='/usr/local/bin/fastnode-cli'
COIN_REPO='https://github.com/Fast-Node/FNS_core/releases/download/2.0.0.1-Unix/fastnode-2.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='fastnode'
COIN_PORT=47452
